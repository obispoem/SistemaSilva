...
public class JDlgCategoria extends javax.swing.JDialog {
    ...
    private void habilitar(boolean status) {
        ...
        ebs_jTxtid_categoria.setEnabled(status);
    ...
    private void limparCampos() {
        ebs_jTxtid_categoria.setText("");
        ebs_jTxtnome.setText("");
    }

    public Ebs_Categoria viewPbean() {
        ...
        try {
            ...
            categoria.setEbs_id_categoria(Integer.parseInt(idText));
    ...
    public void beanPview(Ebs_Categoria categoria) {
        ebs_jTxtid_categoria.setText(String.valueOf(categoria.getEbs_id_categoria()));
        ebs_jTxtnome.setText(categoria.getEbs_nome());
    }
    ...
    private void ebs_jBtnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ebs_jBtnAlterarActionPerformed
        if (pesquisar == false) {
            ...
            beanPview((Ebs_Categoria) categoriaDAO.list(Integer.parseInt(resp)));
        }
        habilitar(true);
        ebs_jTxtid_categoria.setEnabled(false);
        incluir = false;
        pesquisar = false;
    ...
    private void ebs_jBtnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ebs_jBtnExcluirActionPerformed
        ...
        if (resp == JOptionPane.YES_OPTION) {
            Ebs_Categoria categoria = viewPbean();
            Ebs_categoriaDAO categoriaDAO = new Ebs_categoriaDAO();
